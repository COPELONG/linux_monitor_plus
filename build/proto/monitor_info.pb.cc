...
static void InitDefaultsscc_info_GetRequest_monitor_5finfo_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::monitor::proto::_GetRequest_default_instance_;
    new (ptr) ::monitor::proto::GetRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetRequest_monitor_5finfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetRequest_monitor_5finfo_2eproto}, {}};
...
static void InitDefaultsscc_info_SetResponse_monitor_5finfo_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::monitor::proto::_SetResponse_default_instance_;
    new (ptr) ::monitor::proto::SetResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_SetResponse_monitor_5finfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_SetResponse_monitor_5finfo_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_monitor_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::monitor::proto::SetResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::monitor::proto::SetResponse, result_),
  PROTOBUF_FIELD_OFFSET(::monitor::proto::SetResponse, sucess_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::monitor::proto::GetRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::monitor::proto::GetRequest, get_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::monitor::proto::MonitorInfo)},
  { 11, -1, sizeof(::monitor::proto::ResultCode)},
  { 18, -1, sizeof(::monitor::proto::SetResponse)},
  { 25, -1, sizeof(::monitor::proto::GetRequest)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::monitor::proto::_SetResponse_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::monitor::proto::_GetRequest_default_instance_),
};
...
const char descriptor_table_protodef_monitor_5finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\003(\0132\026.monitor.proto.NetInfo\"-\n\nResultCod"
  "e\022\017\n\007errcode\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\014\"H\n\013Se"
  "tResponse\022)\n\006result\030\001 \001(\0132\031.monitor.prot"
  "o.ResultCode\022\016\n\006sucess\030\002 \001(\010\"\031\n\nGetReque"
  "st\022\013\n\003get\030\001 \001(\0142\244\001\n\013GrpcManager\022J\n\016SetMo"
  "nitorInfo\022\032.monitor.proto.MonitorInfo\032\032."
  "monitor.proto.SetResponse\"\000\022I\n\016GetMonito"
  "rInfo\022\031.monitor.proto.GetRequest\032\032.monit"
  "or.proto.MonitorInfo\"\000B\003\200\001\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_monitor_5finfo_2eproto_sccs[4] = {
  &scc_info_GetRequest_monitor_5finfo_2eproto.base,
  &scc_info_MonitorInfo_monitor_5finfo_2eproto.base,
  &scc_info_ResultCode_monitor_5finfo_2eproto.base,
  &scc_info_SetResponse_monitor_5finfo_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_monitor_5finfo_2eproto = {
  false, false, descriptor_table_protodef_monitor_5finfo_2eproto, "monitor_info.proto", 715,
  &descriptor_table_monitor_5finfo_2eproto_once, descriptor_table_monitor_5finfo_2eproto_sccs, descriptor_table_monitor_5finfo_2eproto_deps, 4, 6,
...
class SetResponse::_Internal {
 public:
  static const ::monitor::proto::ResultCode& result(const SetResponse* msg);
};
...
SetResponse::SetResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:monitor.proto.SetResponse)
}
SetResponse::SetResponse(const SetResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:monitor.proto.SetResponse)
}

void SetResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_SetResponse_monitor_5finfo_2eproto.base);
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
...
SetResponse::~SetResponse() {
  // @@protoc_insertion_point(destructor:monitor.proto.SetResponse)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:monitor.proto.SetResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    CHK_(ptr);
    switch (tag >> 3) {
      // .monitor.proto.ResultCode result = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
...
::PROTOBUF_NAMESPACE_ID::uint8* SetResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:monitor.proto.SetResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:monitor.proto.SetResponse)
  return target;
}

size_t SetResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:monitor.proto.SetResponse)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:monitor.proto.SetResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const SetResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<SetResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:monitor.proto.SetResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:monitor.proto.SetResponse)
    MergeFrom(*source);
  }
}

void SetResponse::MergeFrom(const SetResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:monitor.proto.SetResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:monitor.proto.SetResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:monitor.proto.SetResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void SetResponse::InternalSwap(SetResponse* other) {
  ...
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SetResponse, sucess_)
      + sizeof(SetResponse::sucess_)
      - PROTOBUF_FIELD_OFFSET(SetResponse, result_)>(
...
GetRequest::GetRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:monitor.proto.GetRequest)
}
GetRequest::GetRequest(const GetRequest& from)
  ...
  if (!from._internal_get().empty()) {
    get_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_get(), 
      GetArena());
  }
  // @@protoc_insertion_point(copy_constructor:monitor.proto.GetRequest)
}

void GetRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetRequest_monitor_5finfo_2eproto.base);
  get_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

GetRequest::~GetRequest() {
  // @@protoc_insertion_point(destructor:monitor.proto.GetRequest)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:monitor.proto.GetRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:monitor.proto.GetRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:monitor.proto.GetRequest)
  return target;
}

size_t GetRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:monitor.proto.GetRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:monitor.proto.GetRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const GetRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:monitor.proto.GetRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:monitor.proto.GetRequest)
    MergeFrom(*source);
  }
}

void GetRequest::MergeFrom(const GetRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:monitor.proto.GetRequest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:monitor.proto.GetRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:monitor.proto.GetRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* GrpcManager::descriptor() {
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* GrpcManager::GetDescriptor() {
  return descriptor();
}

void GrpcManager::SetMonitorInfo(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::monitor::proto::MonitorInfo*,
                         ::monitor::proto::SetResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method SetMonitorInfo() not implemented.");
  done->Run();
}

void GrpcManager::GetMonitorInfo(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::monitor::proto::GetRequest*,
...
void GrpcManager::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
    ...
    case 0:
      SetMonitorInfo(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::monitor::proto::MonitorInfo*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::monitor::proto::SetResponse*>(
                 response),
             done);
      break;
    case 1:
      GetMonitorInfo(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::monitor::proto::GetRequest*>(
                 request),
...
const ::PROTOBUF_NAMESPACE_ID::Message& GrpcManager::GetRequestPrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::monitor::proto::GetRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& GrpcManager::GetResponsePrototype(
    const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
      return ::monitor::proto::SetResponse::default_instance();
    case 1:
      return ::monitor::proto::MonitorInfo::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
GrpcManager_Stub::GrpcManager_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel)
  : channel_(channel), owns_channel_(false) {}
GrpcManager_Stub::GrpcManager_Stub(
...
void GrpcManager_Stub::SetMonitorInfo(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void GrpcManager_Stub::GetMonitorInfo(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
template<> PROTOBUF_NOINLINE ::monitor::proto::SetResponse* Arena::CreateMaybeMessage< ::monitor::proto::SetResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::monitor::proto::SetResponse >(arena);
}
template<> PROTOBUF_NOINLINE ::monitor::proto::GetRequest* Arena::CreateMaybeMessage< ::monitor::proto::GetRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::monitor::proto::GetRequest >(arena);
}
