...
PROTOBUF_NAMESPACE_OPEN
template<> ::monitor::proto::GetRequest* Arena::CreateMaybeMessage<::monitor::proto::GetRequest>(Arena*);
...
template<> ::monitor::proto::SetResponse* Arena::CreateMaybeMessage<::monitor::proto::SetResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace monitor {
namespace proto {
...
class SetResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:monitor.proto.SetResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "monitor.proto.SetResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:monitor.proto.SetResponse)
 private:
  class _Internal;
...
class GetRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:monitor.proto.GetRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "monitor.proto.GetRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:monitor.proto.GetRequest)
 private:
  class _Internal;
...
class GrpcManager_Stub;

class GrpcManager : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(GrpcManager);
};

class GrpcManager_Stub : public GrpcManager {
 public:
  GrpcManager_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  GrpcManager_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(GrpcManager_Stub);
};
...
inline const ::monitor::proto::ResultCode& SetResponse::_internal_result() const {
...
inline const ::monitor::proto::ResultCode& SetResponse::result() const {
  // @@protoc_insertion_point(field_get:monitor.proto.SetResponse.result)
...
inline void SetResponse::unsafe_arena_set_allocated_result(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:monitor.proto.SetResponse.result)
}
inline ::monitor::proto::ResultCode* SetResponse::release_result() {
...
inline ::monitor::proto::ResultCode* SetResponse::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:monitor.proto.SetResponse.result)
  
  ::monitor::proto::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::monitor::proto::ResultCode* SetResponse::_internal_mutable_result() {
...
inline ::monitor::proto::ResultCode* SetResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:monitor.proto.SetResponse.result)
  return _internal_mutable_result();
}
inline void SetResponse::set_allocated_result(::monitor::proto::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:monitor.proto.SetResponse.result)
}

// bool sucess = 2;
inline void SetResponse::clear_sucess() {
  sucess_ = false;
}
inline bool SetResponse::_internal_sucess() const {
  return sucess_;
}
inline bool SetResponse::sucess() const {
  // @@protoc_insertion_point(field_get:monitor.proto.SetResponse.sucess)
  return _internal_sucess();
}
inline void SetResponse::_internal_set_sucess(bool value) {
  
  sucess_ = value;
}
inline void SetResponse::set_sucess(bool value) {
  _internal_set_sucess(value);
  // @@protoc_insertion_point(field_set:monitor.proto.SetResponse.sucess)
}
...
inline const std::string& GetRequest::get() const {
  // @@protoc_insertion_point(field_get:monitor.proto.GetRequest.get)
  return _internal_get();
}
inline void GetRequest::set_get(const std::string& value) {
  _internal_set_get(value);
  // @@protoc_insertion_point(field_set:monitor.proto.GetRequest.get)
}
inline std::string* GetRequest::mutable_get() {
  // @@protoc_insertion_point(field_mutable:monitor.proto.GetRequest.get)
  return _internal_mutable_get();
}
inline const std::string& GetRequest::_internal_get() const {
  return get_.Get();
}
inline void GetRequest::_internal_set_get(const std::string& value) {
  
  get_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void GetRequest::set_get(std::string&& value) {
  
  get_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:monitor.proto.GetRequest.get)
}
inline void GetRequest::set_get(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  get_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:monitor.proto.GetRequest.get)
}
inline void GetRequest::set_get(const void* value,
    size_t size) {
  
  get_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:monitor.proto.GetRequest.get)
}
inline std::string* GetRequest::_internal_mutable_get() {
  
  return get_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* GetRequest::release_get() {
  // @@protoc_insertion_point(field_release:monitor.proto.GetRequest.get)
  return get_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void GetRequest::set_allocated_get(std::string* get) {
  if (get != nullptr) {
    
  } else {
    
  }
  get_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), get,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:monitor.proto.GetRequest.get)
}
